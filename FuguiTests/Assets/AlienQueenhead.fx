...
float4 DiffuseColor  = { 0.588000f, 0.588000f, 0.588000f, 1.000000f }; 
...
sampler2D Map__14Sampler = sampler_state  // TexCoord0 
{ 
   Texture = <Map__14>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
sampler2D Map__20Sampler = sampler_state  // TexCoord1 
{ 
   Texture = <Map__20>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
sampler2D Map__19Sampler = sampler_state  // TexCoord2 
{ 
   Texture = <Map__19>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
{ 
   //TODO: Modify the folowing code: 
   float4 color = tex2D( Map__14Sampler, vout.TexCoord0 ); 
