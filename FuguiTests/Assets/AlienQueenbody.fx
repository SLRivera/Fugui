...
float4 DiffuseColor  = { 0.588235f, 0.588235f, 0.588235f, 1.000000f }; 
float  SpecularPower = 9.999999f; 
...
sampler2D Map__21Sampler = sampler_state  // TexCoord0 
{ 
   Texture = <Map__21>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
sampler2D Map__24Sampler = sampler_state  // TexCoord1 
{ 
   Texture = <Map__24>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
sampler2D Map__25Sampler = sampler_state  // TexCoord2 
{ 
   Texture = <Map__25>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
{ 
   //TODO: Modify the folowing code: 
   float4 color = tex2D( Map__21Sampler, vout.TexCoord0 ); 
